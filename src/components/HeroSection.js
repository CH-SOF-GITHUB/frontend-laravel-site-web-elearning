...
function HeroSection(props) {
    ...
    return (
        <div className='hero-container'>
            ...
            {isLoggedIn ?(<p className="p-5">You are already logged in! Explore our features.</p>): (
                 <div className="hero-btns">
                 <Button className='btns' buttonStyle='btn--calltoaction' buttonSize='btn--large'>
                     <Link className='btnsLink' to={props.path}>GET STARTED</Link>
                 </Button>
             </div>
            )}
